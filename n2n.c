 ...
 *  将新添加到列表的头部。 如果列表为NULL; 创造它。
 *  The item new is added to the head of the list. New is modified during
 *  insertion. list takes ownership of new.新项目被添加到列表的头部。 新过程在修改期间
 *  插入。 清单取得新的所有权。
 */
...
/* @return zero if the two sockets are equivalent.如果两个套接字相等，则返回零 */
