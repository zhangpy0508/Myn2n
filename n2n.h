...
/* N2N packet header indicators. N2N分组报头指示符*/
#define MSG_TYPE_REGISTER               1  //将REGISTER从一个边缘转发到下一个边缘
#define MSG_TYPE_DEREGISTER             2
#define MSG_TYPE_PACKET                 3  //PACKET通过超级节点从一个边缘到另一个边缘
#define MSG_TYPE_REGISTER_ACK           4
#define MSG_TYPE_REGISTER_SUPER         5  //边缘到超级节点的注册请求
